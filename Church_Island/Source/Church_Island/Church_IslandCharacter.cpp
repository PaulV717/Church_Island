...
void AChurch_IslandCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AChurch_IslandCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AChurch_IslandCharacter::Look);
	}
	else
	{
...
void AChurch_IslandCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AChurch_IslandCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
